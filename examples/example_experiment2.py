...
suite_name = "bbob-noisy"  # see cocoex.known_suite_names
budget_multiplier = 10000  # times dimension, increase to 10, 100, ...
...
suite_year_option = "instances: 1-5,1-5,1-5"  # "year: 2023"  # determine instances by year, not all years work for all suites :-(
